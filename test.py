...
datafile = pd.read_csv ("C:\\Users\\Anshu Khare\\Desktop\\iris.csv" , header=None)
#print(datafile)
#datafile1 = numpy_array = np.genfromtxt("C:\\Users\\Anshu Khare\\Desktop\\iris.csv", delimiter=";", skip_header=1)
#print(datafile1)
#print(datafile._data.T)
datafile.to_numpy()
#print(datafile)

#print(datafile.transpose)
sepal_length = datafile[0]
sepal_width = datafile[1]
petal_length = datafile[2]
petal_width = datafile[3]

plt.scatter(sepal_length[0:50] , sepal_width[0:50] , c='red')
plt.scatter(sepal_length[51:101] , sepal_width[51:101] , c='green')
plt.scatter(sepal_length[101:150] , sepal_width[101:150] , c='blue')
plt.show()
